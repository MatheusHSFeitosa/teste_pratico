...
<body>
    ...
    <?php require_once("../controller/ControllerEditar_docente.php");?>
    <div class="row">
        <form method="post" action="../controller/ControllerEditar_docente.php" id="form" name="form" onsubmit="validar(document.form); return false;" class="col-10">
